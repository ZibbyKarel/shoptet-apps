...
3. [ ] bulk-modal -> toastReagion: Toasty by měly být handlovány globálně. Jeden ToastRegion pro všechny toasty v aplikaci tzn vytvořit globální ToastContextProvider a nějaké "useNotify" které toasty do globálního Provideru dostane. Odstraň všechny lokální ToasRegiony a sjednoť vše pod useNotify hook
4. [ ] bulk-modal -> pokud uživatel nakliká více než 5 rezervací za měsíc, mělo by se mu přidání další rezervace zakázat disablováním tlačítek ve formuláři. Také dny, na které už uživatel rezervaci má, musejí být barevně zvírazněny. Použij stejnou rozhodovací logiku jako u barev aut, a změň pozadí dní v kalendáři na které už uživatel rezervaci má.
