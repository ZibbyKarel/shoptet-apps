 ...
 *
 * It lives in `apps/garage/web` rather than in `libs/shared/design-system/src/compounds`
...
import { Box, List, ListItem, Stack, Text } from '@garage/design-system/primitives';
